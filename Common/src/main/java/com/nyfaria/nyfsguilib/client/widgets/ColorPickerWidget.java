...
public class ColorPickerWidget<T extends GuiEventListener> extends ParentWidget<T> {
    ...
    public ColorPickerWidget(T parent, int pX, int pY, int pWidth, int pHeight, Component pMessage, OnColorChanged onColorChanged) {
    ...
    public void init(boolean rebuild) {
        this.colorWheelWidget = this.addRenderableWidget(new ColorWheelWidget(this.getX() + 5, this.getY() + 5, 70, 70, null, (hue, saturation) -> {
            this.currentHue = hue;
        ...
        this.vanillaColorPickerWidget = this.addRenderableWidget(new VanillaColorPickerWidget(this.getX() + 5, this.getY() + 77, 95, Component.literal(""), (color) -> {
            this.setFromRBG(color);
            this.onColorChanged.onColorChanged(color);
        }));
        Font font = Minecraft.getInstance().font;
        this.redEditBox = this.addRenderableWidget(new EditBox(font, this.getX() + 97, this.getY() + 5, 26, 10, Component.literal("r")));
        this.greenEditBox = this.addRenderableWidget(new EditBox(font, this.getX() + 97, this.getY() + 20, 26, 10, Component.literal("g")));
        this.blueEditBox = this.addRenderableWidget(new EditBox(font, this.getX() + 97, this.getY() + 35, 26, 10, Component.literal("b")));
        this.hueEditBox = this.addRenderableWidget(new EditBox(font, this.getX() + 97, this.getY() + 50, 26, 10, Component.literal("h")));
        this.saturationEditBox = this.addRenderableWidget(new EditBox(font, this.getX() + 97, this.getY() + 65, 26, 10, Component.literal("s")));
        this.valueEditBox = this.addRenderableWidget(new EditBox(font, this.getX() + 97, this.getY() + 80, 26, 10, Component.literal("v")));
